...
if __name__ == "__main__":
    ...
    if 1 in args.parts:
        ...
        print("Best Validation Accuracy was with " + str(best_iter) + "iterations: " + str(min(val1)))
        # predict test values
    ...
    if 2 in args.parts:
        ...
        print("Best Validation Accuracy was with " + str(best_iter) + "iterations: " + str(min(val2)))
        # predict test values
    ...
    if 3 in args.parts:
        ...
        for acc in [1-x/float(n_val) for x in min_errs]:
            ...
            p+=1
        print("The best value for P is "+str(best_p))
        if not args.hide:
            p=1
            # plot for each p
